...
import com.lr.best.db.HandShakeBean;
import com.lr.best.db.PulseData;
        ...
        socketActionAdapter = new SocketActionAdapter() {
            ...
            public void onSocketDisconnection(ConnectionInfo info, String action, Exception e) {
                ...
                if (e != null) {
                    if (e instanceof RedirectException) {
                        ...
                        manager.switchConnectionInfo(((com.lr.best.service.RedirectException)e).redirectInfo);
                        manager.connect();
                    } else {
            ...
            public void onSocketReadResponse(ConnectionInfo info, String action, OriginalData data) {
                ...
                if (cmd == 54) {//登陆成功
                    ...
                    manager.disconnect(new com.lr.best.service.RedirectException(redirectInfo));
                } else if (cmd == 14) {//心跳
