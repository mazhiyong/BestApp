...
import com.lr.best.ui.moudle1.adapter.HelpListAdapter;
 ...
 * 公告消息中心  界面
 */
public class HelpListActivity extends BasicActivity implements RequestView,ReLoadingData,SelectBackListener{
...
//        responseData();
    ...
    private void initView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(HelpListActivity.this);
    ...
    private void traderListAction(){
        ...
        mRequestTag = MethodUrl.LIST_HELP;
        Map<String, Object> map = new HashMap<>();
        if (UtilTools.empty(MbsConstans.ACCESS_TOKEN)){
            MbsConstans.ACCESS_TOKEN = SPUtils.get(HelpListActivity.this,MbsConstans.ACCESS_TOKEN,"").toString();
        }
        map.put("token",MbsConstans.ACCESS_TOKEN);
        Map<String, String> mHeaderMap = new HashMap<String, String>();
        mRequestPresenterImp.requestPostToMap(mHeaderMap, MethodUrl.LIST_HELP, map);
    }
    ...
    private void responseData() {
        if (mListAdapter == null) {
            mListAdapter = new HelpListAdapter(HelpListActivity.this);
...
//设置底部加载颜色
    ...
    private void initPopupWindow(){
        ...
        int nH = UtilTools.getNavigationBarHeight(HelpListActivity.this);
        ...
        if (mConditionDialog == null) {
            ...
            popView = LayoutInflater.from(HelpListActivity.this).inflate(R.layout.dialog_trade_condition,null);
            ...
            int screenWidth=UtilTools.getScreenWidth(HelpListActivity.this);
            int screenHeight=UtilTools.getScreenHeight(HelpListActivity.this);
            ...
            mConditionDialog.setBackgroundDrawable(CornerUtils.cornerDrawable(Color.parseColor("#ffffff"), UtilTools.dip2px(HelpListActivity.this,5)));
...
//            mConditionDialog.setAnimationStyle(android.R.style.Animation_Activity);//使用系统动画
            ...
            mConditionDialog.showAtLocation(HelpListActivity.this.getWindow().getDecorView(),  Gravity.TOP|Gravity.RIGHT, 0, 0);
            toggleBright();
    ...
    private void initConditionDialog(View view){
        ...
        GridLayoutManager linearLayoutManager = new GridLayoutManager(HelpListActivity.this,3);
        mTypeRecyclerView.setLayoutManager(linearLayoutManager);
        mTradeDialogAdapter = new TradeDialogAdapter(HelpListActivity.this,maps);
        //第一次设置默认值
        mSelectType = "borrow";
        ...
        switch (mType){
            case MethodUrl.LIST_HELP:
                switch (tData.get("code")+""){
                    ...
                    case "1":
                        closeAllActivity();
                        intent = new Intent(HelpListActivity.this, LoginActivity.class);
                        startActivity(intent);
                        break;
                    case "-1":
