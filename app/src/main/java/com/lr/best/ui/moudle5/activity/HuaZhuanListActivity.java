 ...
 * 划转记录  界面
 */
public class HuaZhuanListActivity extends BasicActivity implements RequestView,ReLoadingData,SelectBackListener{
    ...
    private void initView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(HuaZhuanListActivity.this);
    ...
    private void responseData() {
        if (mListAdapter == null) {
            mListAdapter = new HuaZhuanListAdapter(HuaZhuanListActivity.this);
...
//设置底部加载颜色
    ...
    private void initPopupWindow(){
        ...
        int nH = UtilTools.getNavigationBarHeight(HuaZhuanListActivity.this);
        ...
        if (mConditionDialog == null) {
            ...
            popView = LayoutInflater.from(HuaZhuanListActivity.this).inflate(R.layout.dialog_trade_condition,null);
            ...
            int screenWidth=UtilTools.getScreenWidth(HuaZhuanListActivity.this);
            int screenHeight=UtilTools.getScreenHeight(HuaZhuanListActivity.this);
...
//            mConditionDialog.setAnimationStyle(android.R.style.Animation_Activity);//使用系统动画
            ...
            mConditionDialog.showAtLocation(HuaZhuanListActivity.this.getWindow().getDecorView(),  Gravity.TOP|Gravity.RIGHT, 0, 0);
            toggleBright();
    ...
    private void initConditionDialog(View view){
        ...
        GridLayoutManager linearLayoutManager = new GridLayoutManager(HuaZhuanListActivity.this,3);
        mTypeRecyclerView.setLayoutManager(linearLayoutManager);
        mTradeDialogAdapter = new TradeDialogAdapter(HuaZhuanListActivity.this,maps);
        //第一次设置默认值
        mSelectType = "borrow";
