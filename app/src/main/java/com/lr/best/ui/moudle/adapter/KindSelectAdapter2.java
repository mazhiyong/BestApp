...
public class KindSelectAdapter2 extends RecyclerView.Adapter<KindSelectAdapter2.ViewHolder>{
    ...
    public KindSelectAdapter2(Context context, List<Map<String, Object>> datas, int type) {
        mContext = context;
        mDatas = datas;
        mType=type;
    }
