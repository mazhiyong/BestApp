...
import com.lr.best.ui.moudle5.adapter.TradeListAdapter;
...
public class TradeListActivity extends BasicActivity implements RequestView,ReLoadingData,SelectBackListener{
    ...
    private void initView() {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(TradeListActivity.this);
    ...
    private void responseData() {
        if (mTradeListAdapter == null) {
            mTradeListAdapter = new TradeListAdapter(TradeListActivity.this);
            ...
            mLRecyclerViewAdapter = new LRecyclerViewAdapter(mTradeListAdapter);
...
//            mLRecyclerViewAdapter.addHeaderView(headerView);
            ...
            mLRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
                ...
                public void onItemClick(View view, int position) {
                    Map<String, Object> item = mTradeListAdapter.getDataList().get(position);
...
//设置底部加载颜色
        ...
        mTradeListAdapter.notifyDataSetChanged();
        if (mTradeListAdapter.getDataList().size() <= 0){
            mPageView.showEmpty();
        }else {
    ...
    private void initPopupWindow(){
        ...
        int nH = UtilTools.getNavigationBarHeight(TradeListActivity.this);
        ...
        if (mConditionDialog == null) {
            ...
            popView = LayoutInflater.from(TradeListActivity.this).inflate(R.layout.dialog_trade_condition,null);
            ...
            int screenWidth=UtilTools.getScreenWidth(TradeListActivity.this);
            int screenHeight=UtilTools.getScreenHeight(TradeListActivity.this);
            ...
            mConditionDialog.setBackgroundDrawable(CornerUtils.cornerDrawable(Color.parseColor("#ffffff"), UtilTools.dip2px(TradeListActivity.this,5)));
...
//            mConditionDialog.setAnimationStyle(android.R.style.Animation_Activity);//使用系统动画
            ...
            mConditionDialog.showAtLocation(TradeListActivity.this.getWindow().getDecorView(),  Gravity.TOP|Gravity.RIGHT, 0, 0);
            toggleBright();
    ...
    private void initConditionDialog(View view){
        ...
        GridLayoutManager linearLayoutManager = new GridLayoutManager(TradeListActivity.this,3);
        mTypeRecyclerView.setLayoutManager(linearLayoutManager);
        mTradeDialogAdapter = new TradeDialogAdapter(TradeListActivity.this,maps);
        //第一次设置默认值
        mSelectType = "borrow";
