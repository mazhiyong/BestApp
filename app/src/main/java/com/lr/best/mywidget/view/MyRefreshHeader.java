...
public class MyRefreshHeader extends LinearLayout implements IRefreshHeader {
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext()).inflate(R.layout.my_listview_header, null);
    ...
    private View initIndicatorView(int style) {
        ...
        ImageView progressView = (ImageView) LayoutInflater.from(getContext()).inflate(R.layout.refresh_anim_view, null);
        AnimationDrawable aniDrawable;
        aniDrawable = (AnimationDrawable) ((ImageView)progressView).getDrawable();
        aniDrawable.start();
        return progressView;
    }
