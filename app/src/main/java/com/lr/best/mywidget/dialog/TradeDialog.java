...
import com.lr.best.ui.moudle.adapter.KindSelectAdapter;
 ...
 * 购买或出售  弹框
 */
public class TradeDialog extends BaseDialog {
    ...
    public TradeDialog(Context context, boolean isPopupStyle, List<Map<String, Object>> datas, int type) {
